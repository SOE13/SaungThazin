import { StyleSheet, Text, View ,SafeAreaView,TextInput,ToastAndroid, Image, Alert, TouchableOpacity, ScrollView } from 'react-native'
  ...
  return (
    <ScrollView style={{backgroundColor:COLORS.backgroung}}>
      ...
      <View style={styles.formGroup}>
          ...
          <TextInput onFocus={()=>setActiveInput('name')}
           value={name}
           placeholder='Name'
          ...
          style={{
            ...
            paddingVertical:10,
            borderWidth:1,
            borderColor:activeInput=='name'?COLORS.primary : COLORS.white
          }} />
      </View>
      
      <View style={styles.formGroup}>
          <Text style={styles.formLabel}>Account</Text>
          <TextInput onFocus={()=>setActiveInput('account')}
           value={account}
          ...
          style={{
            ...
            paddingVertical:10,
            borderWidth:1,
            borderColor:activeInput=='account'?COLORS.primary : COLORS.white
          }} />
      </View>
      
      <View style={styles.formGroup}>
          <Text style={styles.formLabel}>Account NO</Text>
          <TextInput onFocus={()=>setActiveInput('accountNo')}
           value={accountNo}
          ...
          style={{
            ...
            paddingVertical:10,
            borderWidth:1,
            borderColor:activeInput=='accountNo'?COLORS.primary : COLORS.white
          }} />
      </View>
